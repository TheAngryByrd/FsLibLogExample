...
[<assembly: AssemblyTitleAttribute("FsLibLogExample.Tests")>]
[<assembly: AssemblyProductAttribute("FsLibLogExample")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FsLibLogExample.Tests"
    let [<Literal>] AssemblyProduct = "FsLibLogExample"
